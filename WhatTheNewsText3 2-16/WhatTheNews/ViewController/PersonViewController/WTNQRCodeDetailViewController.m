//
//  WTNQRCodeDetailViewController.m
//  WhatTheNews
//
...
@interface WTNQRCodeDetailViewController ()<AVCaptureMetadataOutputObjectsDelegate>
...
@implementation WTNQRCodeDetailViewController
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    if (metadataObjects.count > 0)
    {
        ...
        if (obj.stringValue && ![obj.stringValue isEqualToString:@""] && obj.stringValue.length > 0)
        {
            ...
            {
                if (self.WTNQRCodeSuncessBlock) {
                    self.WTNQRCodeSuncessBlock(self,obj.stringValue);
                }
            }
            else
            {
                if (self.WTNQRCodeFailBlock) {
                    self.WTNQRCodeFailBlock(self);
                }
            }
        }
        else
...
- (void)cancleSYQRCodeReading
{
    ...
    if (self.WTNQRCodeCancleBlock)
    {
        self.WTNQRCodeCancleBlock(self);
    }
